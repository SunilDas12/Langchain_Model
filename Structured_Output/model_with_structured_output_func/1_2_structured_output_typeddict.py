...
class Review(TypedDict):
    key_themes: Annotated[list[str], "List of key themes or topics in the review"]
    summary: Annotated[str, "A brief summary of the review"]
    sentiment: Annotated[Literal["pos","neg"], "Return sentiment of the review, either positive, negative or neutral"]
    pros: Annotated[Optional[list[str]], "List of all pros aspects mentioned in the review"] 
    cons: Annotated[Optional[list[str]], "List of all cons aspects mentioned in the review"] 
